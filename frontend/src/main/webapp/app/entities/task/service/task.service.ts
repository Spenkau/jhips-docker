...
export class TaskService {
  ...
  protected resourceUrl2 = this.applicationConfigService.getEndpointFor('api/test');
  ...
  test(): Observable<any> {
    return this.http.get(this.resourceUrl2, {observe: 'response'})
      .pipe(map((res) => this.convertDateFromServer2(res)));
  }

  protected convertDateFromServer2(restTest: any): ITask {
    return {
      ...restTest
    };
  }
